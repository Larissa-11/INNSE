...
def vimeo90k(mode):
    ...
    if mode == 'GT':
        ...
        # txt_file = '/home/zyf/code/MIMO-VRN-main/codes/datasets/vimeo_septuplet/sep_testlist.txt'
        H_dst, W_dst = 256, 448
    elif mode == 'LR':
        img_folder = '../datasets/vimeo90k/vimeo_septuplet_matlabLRx4/sequences'
        lmdb_save_path = '../datasets/vimeo90k/vimeo90k_train_LR.lmdb'
        txt_file = '../datasets/vimeo90k/vimeo_septuplet_matlabLRx4/sep_trainlist.txt'
        H_dst, W_dst = 64, 112
    elif mode == 'flow':
        img_folder = '../../datasets/vimeo90k/vimeo90k/sequences_flowx4'
        lmdb_save_path = '../../datasets/vimeo90k/vimeo90k_train_flowx4.lmdb'
        txt_file = '../../datasets/vimeo90k/vimeo90k/sep_trainlist.txt'
        H_dst, W_dst = 128, 112
    else:

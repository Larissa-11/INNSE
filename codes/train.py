            ...
            if current_step % opt['train']['val_freq'] == 0 and rank <= 0:
                ...
                if opt['model'] == 'V_IRN':
                    for val_data in val_loader:
                        ...
                        img_dir = os.path.join(opt['path']['val_images'], folder)
                        util.mkdir(img_dir)
                        ...
                        for i in range(t_step):
                            img_name = os.path.splitext(os.path.basename(val_data['LQ_path'][i][0]))[0]
                            ...
                            # Save LR images
                            save_img_path_L = os.path.join(img_dir,
                            ...
                            if current_step == opt['train']['val_freq']:
                                ...
                                util.save_img(lrgt_img, save_img_path_gtl)
                    ...
                    for val_data in val_loader:
                        ...
                        # calculate PSNR
                        psnr, psnr_lr = cal_pnsr(opt, sr_img, gt_img, lr_img, gtl_img)
